...
<html lang="en">
    <head>
        ...
        <link href="/css/bstyles.css" rel="stylesheet" />
        <!-- CSS only -->
            ...
            <div id="page-content-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                    <div class="container-fluid">
                       ...
                       <a href="/board/register.jsp"><button class="btn btn-primary" id="sidebarToggle" >게시글 등록</button><a/>
                      	</c:if>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">정렬</a>
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="/brd/recoList">추천수</a>
                                      <!--   <a class="dropdown-item" href="#!"></a> -->
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="/brd/list">정렬 및 검색해제</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
